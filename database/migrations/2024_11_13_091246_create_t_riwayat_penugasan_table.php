...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('t_riwayat_penugasan', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('id_tugas'); // Foreign key ke tabel t_progress_tugas
            $table->unsignedBigInteger('id_mahasiswa'); // Foreign key ke tabel m_mahasiswa
            ...
            $table->integer('kuota'); // Kuota tugas
            $table->integer('nilai_kompen'); // Nilai kompen
            $table->string('deskripsi', 50); // Deskripsi tugas
            $table->dateTime('tanggal_dilaksanakan'); // Tanggal pelaksanaan tugas
            $table->dateTime('tanggal'); // Tanggal tugas
